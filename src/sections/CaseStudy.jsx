        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="space-y-8">
              ...
              <a href="https://github.com/RawatAr" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 px-8 py-3.5 rounded-full bg-white text-black text-xs uppercase tracking-widest font-bold hover:scale-105 transition-transform duration-300">
                View Source Code
              </a>
            </div>
          </ScrollReveal>
