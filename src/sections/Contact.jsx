            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:rwtaryan07@gmail.com" className="text-white font-medium hover:text-pink-400 transition-colors">
                    rwtaryan07@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-4 mt-2">
                    ...
                    <a
                      href="https://www.linkedin.com/in/aryanrwt"
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm font-medium"
                    >
                ...
                {status === 'error' && (
                  ...
                  >
                    <div className="mb-2 p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-400 text-sm flex items-center gap-3">
                      ...
                      Failed to send. Email me directly at rwtaryan07@gmail.com
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
