...
const milestones = [
  {
    year: '2021',
    title: 'Matriculation',
    desc: 'Completed early schooling at Kendriya Vidyalaya No.1, Naliya, Gujarat, scoring 92.8%.',
    icon: '🏫',
    tag: 'KV Naliya',
    color: '#ec4899',
  },
  {
    year: '2023',
    title: 'Intermediate & Future Steps',
    desc: 'Completed intermediate in PCM (76%) from KV Adampur. Started my journey into B.Tech CSE at Lovely Professional University.',
    icon: '💡',
    tag: 'LPU & KV',
    color: '#a855f7',
  },
  {
    year: '2024',
    title: 'Content & Freelancer',
    desc: 'Freelance Content Writer at Upwork, writing SEO-focused web copy and ghostwritten pieces. Ranked in the top 5%!',
    icon: '✍️',
    tag: 'Upwork',
    color: '#d946ef',
  },
  {
    ...
    desc: 'Joined Labmentix to build and debug backend features while improving code efficiency and working in professional Agile workflows.',
    icon: '☕',
    tag: 'Labmentix',
    color: '#ec4899',
  },
  {
    year: '2026',
    title: 'The Full-Stack Frontier',
    desc: 'Continuing my journey by building things like the AI Travel Planner and Flappy Bird clone, expanding my horizons in Web and AI.',
    icon: '🧠',
    tag: 'Current Chapter',
    color: '#f43f5e',
  },
