...
const testimonials = [
  {
    quote: "Talent shines, but your dedication sets you apart. Working with Aryan means witnessing someone who truly puts their soul into every line of code.",
  ...
  {
    quote: "Aryan, your dedication turns talent into brilliance. He doesn't just build websites; he builds digital artifacts that feel alive.",
    name: "Raunak Azad",
  ...
  {
    quote: "It’s been an incredible experience seeing Aryan solve complex logic with ease. His passion for clean, scalable code is rare.",
    name: "Aryan Raut",
    role: "Software Developer",
    initials: "AR",
    color: "#f43f5e"
  ...
  {
    quote: "Collaboration is second nature to Aryan. He doesn’t just build products; he ensures the whole team moves forward together.",
