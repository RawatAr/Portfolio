...
import appointyImg from '../images/Appointy.png';
import flappyBirdImg from '../images/Flappy_Bird.png';
import talaashImg from '../images/Talaash_Portal.png';
import travelPlannerImg from '../images/Travel_Plannar.png';
import vanRaahImg from '../images/Van_Raah.png';
...
const projects = [
  {
    ...
    image: flappyBirdImg,
    live: '',
    github: 'https://github.com/RawatAr/flappyBird-JAVA-GUI-Swing-',
    tech: ['Java Swing', 'OOP Design', 'GUI']
  },
  {
    ...
    live: 'https://travel-planner-ai-rust.vercel.app/',
    github: 'https://github.com/RawatAr/travel-planner-ai',
    tech: ['Flask', 'Gemini AI', 'Google APIs']
  },
  {
    title: 'Sports League',
    ...
    image: travelPlannerImg, // Placeholder until user adds the correct image
    live: 'http://sports-league.infy.uk/',
    github: 'https://github.com/RawatAr/Sports-League-Management-System',
    tech: ['HTML', 'JavaScript', 'Tailwind', 'PHP', 'MySQL']
  },
  {
    title: 'Talaash Portal',
    category: 'NGO Platform',
    year: '2024',
    color: 'bg-[#10b981]', // Emerald
    image: talaashImg,
    live: 'https://talaash-portal.vercel.app/',
    github: 'https://github.com/RawatAr/Talaash-Portal',
    tech: ['Web Development', 'UI Design']
  },
  {
    title: 'Van Rah',
    category: 'Ecotourism',
    ...
    image: vanRaahImg,
    live: 'https://van-rah.vercel.app/',
    github: 'https://github.com/RawatAr/Van-Rah',
    tech: ['Frontend', 'Responsive UI']
  },
  {
    title: 'Appointy',
    ...
    image: appointyImg,
    live: 'https://appointy-calendar.vercel.app/',
    github: 'https://github.com/RawatAr/Appointy-Calendar',
    tech: ['UI/UX', 'Calendar Web App']
  }
];
