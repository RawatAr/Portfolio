...
const techGroups = [
  ...
  },
  {
    category: 'Backend & DB',
    skills: [
      { name: 'MERN Stack', level: 'core' },
      { name: 'Flask', level: 'proficient' },
      { name: 'REST APIs', level: 'core' },
      { name: 'MySQL', level: 'proficient' },
      { name: 'PostgreSQL', level: 'proficient' },
      { name: 'Google APIs', level: 'familiar' },
    ]
  },
  {
    category: 'Tools',
    skills: [
      ...
      { name: 'Java Swing', level: 'proficient' },
      { name: 'JavaFX', level: 'familiar' },
      { name: 'Linux', level: 'proficient' },
      { name: 'Windows', level: 'core' },
    ]
  }
];
...
export default function About() {
  ...
  useEffect(() => {
    fetch('https://api.github.com/users/RawatAr')
  ...
  const stats = [
    ...
    { value: 7.4, suffix: '', label: 'CGPA', decimals: 1 },
  ];
            ...
            <BentoCard className="lg:col-span-2">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-3">
                  <h4 className="text-white text-2xl font-bold leading-tight">Software Engineer & Problem Solver</h4>
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    Navigating B.Tech at LPU while architecting high-impact solutions. From building AI travel planners to engaging web platforms, my journey is driven by a desire to solve real-world problems and dominate challenges.
                  </p>
                </div>
                {/* Stats */}
