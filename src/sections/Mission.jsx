        ...
        <div className="flex flex-col">
          <ScrollReveal direction="up" delay={0.2}>
            ...
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter text-white leading-[1.1] mb-8">
              I bridge the gap between <span className="text-transparent" style={{ WebkitTextStroke: '1.5px #ec4899' }}>aspirations</span> <br className="hidden md:block" />& achievements
            </h2>
          </ScrollReveal>

          <ScrollReveal direction="up" delay={0.4}>
            <p className="text-zinc-300 text-lg md:text-xl leading-relaxed mb-6 font-medium">
              I believe in working with pure intention, turning complex logic into real-world impact.
            </p>
            <p className="text-zinc-500 text-sm md:text-base leading-relaxed mb-10 max-w-xl">
              I'm energetic, efficient, self-confident, strong-willed, and determined to dominate challenges. When you live for a strong purpose, hard work isn't an option; it's a necessity.
            </p>
