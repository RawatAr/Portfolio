    ...
    <footer id="contact" className="relative w-full py-24 px-6 md:px-12 bg-black text-white overflow-hidden flex flex-col justify-between min-h-[50vh]">
      <div className="z-10 flex flex-col gap-4 max-w-4xl">
        ...
        <div className="flex gap-4">
          <a href="https://github.com/RawatAr" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:border-pink-500/50 hover:text-pink-400 transition-all duration-300">
            <Github className="w-5 h-5" />
          </a>
          <a href="https://www.linkedin.com/in/aryanrwt" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:border-pink-500/50 hover:text-pink-400 transition-all duration-300">
            <Linkedin className="w-5 h-5" />
          </a>
          <a href="mailto:rwtaryan07@gmail.com" className="w-10 h-10 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:border-pink-500/50 hover:text-pink-400 transition-all duration-300">
        ...
        <div className="grid grid-cols-2 gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="https://www.linkedin.com/in/aryanrwt" target="_blank" rel="noreferrer" className="hover:text-pink-500 transition-colors">LinkedIn</a></li>
              <li><a href="https://github.com/RawatAr" target="_blank" rel="noreferrer" className="hover:text-pink-500 transition-colors">GitHub</a></li>
      ...
      <div className="border-t border-zinc-900 pt-12 flex flex-col md:flex-row justify-between items-center gap-8">
        <p className="text-xs text-zinc-600 uppercase tracking-widest">
          © {new Date().getFullYear()} — Handcrafted by <span className="text-zinc-400">Aryan Rawat</span>
        </p>
        <button
          onClick={scrollToTop}
